...
public class DetalleRegistroCompraController {
	...
	public String MostrarDetalleRegistroCompra(
		...
		Page<DetalleRegistroCompraEntity> detalleregistrocompraPage = servicio.query(search, page, size,
				RecordState.ACTIVE);
	...
	public String MostrarHabilitarDetalleRegistroCompra(
			Model modelo,
			@RequestParam(defaultValue = "0") int page,
			@RequestParam(defaultValue = "5") int size,
			@RequestParam(defaultValue = "") String search) {
	...
	public String RegistrarDetalleRegistroCompra(
			@ModelAttribute("detalleregistrocompra") DetalleRegistroCompraEntity obj) {
		servicio.add(obj);
		return "redirect:/detalleregistrocompra/mostrar";
	}
	...
	public String ActualizarDetalleRegistroCompra(
			@ModelAttribute("detalleregistrocompra") DetalleRegistroCompraEntity obj,
